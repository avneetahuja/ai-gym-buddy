...
const PoseEstimation: React.FC = () => {
  ...
  useEffect(() => {
    if (left_curl_angle>160 && left_lateral_raise_angle>160 && left_shoulder_raise_stage==="down"){
      setLeftShoulderRaiseStage("up");
      setLeftShoulderRaiseCount(left_shoulder_raise_count+1)
    }
    else if(left_curl_angle<160 || left_lateral_raise_angle<160){
        setLeftShoulderRaiseStage("down");
    }
    if(right_curl_angle>160 && right_lateral_raise_angle>160 && right_shoulder_raise_stage==="down"){
      setRightShoulderRaiseStage("up");
      setRightShoulderRaiseCount(right_shoulder_raise_count+1)
    }
    else if(right_curl_angle<160 || right_lateral_raise_angle<160){
